                ...
                <div class="form-value">
                    <form class="form-inline" action="RealizarCita" method="POST">
                        ...
                        <div class="inputbox">
                            ...
                            <c:if test = "${dni == null}">
						       <input type="text" id="dni" name="dni" placeholder="xxxxxxxA" required="required" pattern="[0-9]{8}[A-Za-z]{1}" title="Debe poner 8 n�meros y una letra" minlength="9" maxlength="9">
						       <label style="margin-top:-30px" for="dni">DNI</label>
						       
							</c:if>
							<c:if test = "${dni != null}">
						      	 <input type="text" name="dni" value="${dni}" required="required" readonly pattern="[0-9]{8}[A-Za-z]{1}" title="Debe poner 8 n�meros y una letra" minlength="9" maxlength="9">
