...
<header>
 ...
 <i class="fa-solid fa-triangle-exclamation fa-bounce fa-lg"></i>
  ...
  <span>Error, esto no deberia de haber ocurrido!</span>
    ...
    <!-- card que se mostrará a los clientes cuando no hayan pedido ninguna cita nunca -->
    ...
    <!-- card que se mostrará a los empleados cuando no haya ninguna cita en ese dia -->
      ...
      <!-- cards con las citas pendientes -->
        ...
        <!-- cards de fechas y horas que ya han pasado, tienen un formulario que solo ven los empleados para añadir un infrome y quien ha atendido esa cita -->
      		<c:if test="${citasPosteriores.size() >= 1}">
